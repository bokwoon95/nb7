...
const (
	...
	ErrParentFolderNotProvided   = Error("NB-03140 parent folder not provided")
	...
	ErrSiteNameNotProvided = Error("NB-04119 site name not provided")
	...
	ErrFileGenerationFailed = Error("NB-05030 file generation failed")
