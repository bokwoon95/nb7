...
const (
	...
	ErrMaxSitesReached           = Error("NB-03100 max sites reached")
	ErrMissingFolderArgument     = Error("NB-03110 missing folder argument")
	ErrInvalidFolderArgument     = Error("NB-03120 invalid folder argument")
	ErrNothingToDelete           = Error("NB-03130 nothing to delete")
	ErrDeleteFailed              = Error("NB-03140 delete failed")
	ErrInvalidCategoryType       = Error("NB-03150 invalid category type")
	ErrCategoryAlreadyExists     = Error("NB-03160 category already exists")
	ErrForbiddenFolderName       = Error("NB-03170 forbidden folder name")
	ErrFolderAlreadyExists       = Error("NB-03180 folder already exists")
